...
public:
	static constexpr const char *TYPE_NAME = "DISKANN";

	DiskAnnIndex(const string &name, IndexConstraintType index_constraint_type, const vector<column_t> &column_ids,
	...
	string GetConstraintViolationMessage(VerifyExistenceType verify_type, idx_t failed_index,
		...
		return "Constraint violation in DiskANN index";
	}
